...
function getThroughName(d){
	if(d.indexOf("drive.google") >= 0 ){
		$('#throughname').html('<img id="icon" src="img/drive.svg" />');
	}else if(d.indexOf(".pdf") >= 0 ){
		$('#throughname').html('<img id="icon" src="img/pdf.svg" />');
	}else if(d.indexOf("github") >= 0 ){
		$('#throughname').html('<img id="icon" src="img/github.svg" />');
	}else if(d.indexOf("medium") >= 0 ){
		$('#throughname').html('<img id="icon" src="img/medium.svg" />');
	}else if(d.indexOf("instagram") >= 0 ){
		$('#throughname').html('<img id="icon" src="img/instagram.svg" />');
	}else if(d.indexOf("linkedin") >= 0 ){
		$('#throughname').html('<img id="icon" src="img/linkedin.svg" />');
	}else if(d.indexOf("twitter") >= 0 ){
		$('#throughname').html('<img id="icon" src="img/twitter.svg" />');
	}else if(d.indexOf("alivemachine") >= 0 ){
		$('#throughname').html('<img id="icon" src="img/rabbithole.svg" />');

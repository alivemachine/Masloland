...
function launcher(i){	////////////CROSS FADER
	...
	if(ext=="exe" || ext=="dat" || ext=="bin" || ext=="dll" || ext=="sbd" || ext=="rtf" || ext=="tlb" || ext=="ja" || ext=="chk" || ext=="sig" || ext=="pak" || ext=="DLL" || ext=="wim" || ext=="cab" || ext=="crypt" || ext=="old" || ext=="cat" || ext=="esd" || ext=="ESD" || ext=="psd" || ext=="odt" || ext=="msi" || ext=="3ds" || ext=="3DS" || ext=="tox" || ext=="toe" || ext=="stl" || ext=="eps" || ext=="zip" || ext=="rar" || ext=="docx" || ext=="fbx" || ext=="7z" || ext=="tif" || ext=="DS_Store"){ //if any of thos extension is found
		...
		if(destination[i].indexOf("medium") >= 0 ){
			$("#frame"+framselect).html("<iframe class='iFrameInput' allowFullScreen='true' src='http://alivemachine.io/om2/windows/medium.html' frameborder='0'></iframe>");
		}else if(destination[i].indexOf("github") >= 0 ){
			$("#frame"+framselect).html("<iframe class='iFrameInput' allowFullScreen='true' src='http://alivemachine.io/om2/windows/github.html' frameborder='0'></iframe>");
		}else if(destination[i].indexOf("drive") >= 0 ){
			$("#frame"+framselect).html("<iframe class='iFrameInput' allowFullScreen='true' src='http://alivemachine.io/om2/windows/drive.html' frameborder='0'></iframe>");
		}else if(destination[i].indexOf("instagram") >= 0 ){
			$("#frame"+framselect).html("<iframe class='iFrameInput' allowFullScreen='true' src='http://alivemachine.io/om2/windows/instagram.html' frameborder='0'></iframe>");
		}else if(destination[i].indexOf("linkedin") >= 0 ){
			$("#frame"+framselect).html("<iframe class='iFrameInput' allowFullScreen='true' src='http://alivemachine.io/om2/windows/linkedin.html' frameborder='0'></iframe>");
		}else if(destination[i].indexOf("twitter") >= 0 ){
			$("#frame"+framselect).html("<iframe class='iFrameInput' allowFullScreen='true' src='http://alivemachine.io/om2/windows/twitter.html' frameborder='0'></iframe>");
		}else if(destination[i].indexOf("maslo.ai") >= 0 ){
			$("#frame"+framselect).html("<iframe class='iFrameInput' allowFullScreen='true' src='http://alivemachine.io/om2/windows/masloai.html' frameborder='0'></iframe>");
		}else if(destination[i].indexOf("artcafe") >= 0 ){
			$("#frame"+framselect).html("<iframe class='iFrameInput' allowFullScreen='true' src='http://alivemachine.io/om2/windows/artcafe.html' frameborder='0'></iframe>");
		}else{
